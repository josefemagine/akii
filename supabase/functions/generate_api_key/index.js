...
Deno.serve((req) => __awaiter(void 0, void 0, void 0, function* () {
    return handleRequest(req, (user, body) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const instance = yield queryOne("SELECT id FROM private_ai_instances WHERE id = $1 AND user_id = $2", [instanceId, user.id]);
            if (!instance) {
            ...
            const apiKey = yield queryOne(`INSERT INTO api_keys (
          user_id,
          instance_id,
          name,
          key_prefix,
        ...
        RETURNING id, name, key_prefix, permissions, created_at`, [
            ...
            return createSuccessResponse({
                ...
                apiKey: Object.assign(Object.assign({}, apiKey), { key: fullKey }),
            });
        }
        catch (error) {
