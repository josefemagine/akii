...
const adminCheckCreateSuccessResponse = (data) => {
    return new Response(JSON.stringify(data), {
        status: 200,
        headers: Object.assign(Object.assign({}, adminCheckCorsHeaders), { "Content-Type": "application/json" })
    });
};
const adminCheckCreateErrorResponse = (message, status = 400) => {
...
Deno.serve((req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return adminCheckCreateErrorResponse(error instanceof Error ? error.message : "Failed to check admin status", 500);
    }
}));
