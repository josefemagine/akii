...
// Mock request helper
const createMockRequest = (body = null, method = "POST") => {
...
export function testEdgeFunctionLogging() {
    return __awaiter(this, void 0, void 0, function* () {
        const mockConsole = {
            ...
            warn: function (msg) { this.warns.push(msg); },
        ...
        try {
            ...
            // Test the handler
            const response = yield handler(createMockRequest());
...
export function testEdgeFunctionErrorLogging() {
    return __awaiter(this, void 0, void 0, function* () {
        const mockConsole = {
            logs: [],
            warns: [],
