...
import { BedrockClient, ListFoundationModelsCommand, CreateProvisionedModelThroughputCommand, ListProvisionedModelThroughputsCommand, CommitmentDuration } from "@aws-sdk/client-bedrock";
...
function testListModels() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            console.log(`Success: Found ${((_a = result.modelSummaries) === null || _a === void 0 ? void 0 : _a.length) || 0} foundation models`);
            return {
                success: true,
                modelCount: ((_b = result.modelSummaries) === null || _b === void 0 ? void 0 : _b.length) || 0,
...
function testListProvisionedThroughputs() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
        try {
            ...
            const result = yield client.send(command);
            console.log(`Success: Found ${((_a = result.provisionedModelSummaries) === null || _a === void 0 ? void 0 : _a.length) || 0} provisioned throughputs`);
            return {
                success: true,
                throughputCount: ((_b = result.provisionedModelSummaries) === null || _b === void 0 ? void 0 : _b.length) || 0
            };
        }
        catch (error) {
