...
const getEnv = (name, defaultValue = "") => {
    ...
    try {
        ...
        const value = (_b = (_a = Deno === null || Deno === void 0 ? void 0 : Deno.env) === null || _a === void 0 ? void 0 : _a.get) === null || _b === void 0 ? void 0 : _b.call(_a, name);
...
export const CONFIG = {
    ...
    // Feature flags - Force to true to always use real AWS mode
    USE_REAL_AWS: true,
    // CORS Headers
    CORS_HEADERS: {
