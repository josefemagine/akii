 ...
 */
export const dispatchAuthError = (error, source): void => {
 ...
 */
export const dispatchAuthRecovery = (data): void => {
 ...
 */
export const isValidProfile = (profile): void => {
    if (!profile)
        return false;
    return (!!profile.id &&
        !!profile.email &&
 ...
 */
export const cacheUserProfile = (userId, profile): void => {
    if (!userId || !profile)
        return;
    try {
 ...
 */
export const getCachedProfile = (userId): void => {
    if (!userId)
        return null;
    try {
        const cacheKey = `profile-${userId}`;
 ...
 */
export const hasAdminRole = (profile): void => {
    if (!profile)
        return false;
 ...
 */
export const hasDeveloperRole = (profile): void => {
    if (!profile)
        return false;
