 ...
 */
export function getBedrockApiUrl() {
 ...
 */
export function makeBedrockApiRequest(endpoint_1) {
    return __awaiter(this, arguments, void 0, function* (endpoint, method = 'GET', data, apiKey) {
