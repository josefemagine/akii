 ...
 */
import ReactSingleton from "../react-singleton.tsx";

interface TempoDevtoolsPatchProps {}

// Declare a type for the extended Window object
...
export function patchTempoDevtools() {
    try {
        ...
        const globalAny = window as ExtendedWindow;
        if (globalAny.__TEMPO_DEVTOOLS__) {
            ...
            globalAny.__TEMPO_DEVTOOLS__._React = ReactSingleton;
...
export function verifyTempoPatch() {
    try {
        ...
        if (globalAny.__TEMPO_DEVTOOLS__) {
            ...
            const usingSingleton = tempoReact === ReactSingleton;
