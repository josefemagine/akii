...
// Type for the global symbol registry
type GlobalWithSymbols = typeof globalThis & {
  [REACT_INSTANCE]?: typeof React;
  [REACT_DOM_INSTANCE]?: typeof ReactDOM;
  [REACT_DOM_CLIENT_INSTANCE]?: typeof ReactDOMClient;
  [REACT_ROUTER_INSTANCE]?: typeof ReactRouter;
  [REACT_ROUTER_DOM_INSTANCE]?: typeof ReactRouterDOM;
};

// Get the global object
const global = globalThis as GlobalWithSymbols;
...
export function verifyReactSingleton(): boolean {
