...
export const { createRoutesFromChildren, generatePath, matchPath, matchRoutes, Navigate, Outlet, Route, Routes, useHref, useInRouterContext, useLocation, useMatch, useNavigate, useNavigationType, useOutlet, useParams, useResolvedPath, useRoutes, } = ReactRouter;
// Re-export all the named exports from react-router-dom
export const { BrowserRouter, HashRouter, Link, NavLink, createSearchParams, useSearchParams, } = ReactRouterDOM;
