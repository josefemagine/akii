 ...
 */
import { supabase, supabaseAdmin, auth, debugSupabaseInstances, getSupabaseClient } from "./supabase-singleton.tsx";
interface supabaseProps {}

// Export the clients and auth
export { supabase, supabaseAdmin, auth, debugSupabaseInstances, getSupabaseClient };
