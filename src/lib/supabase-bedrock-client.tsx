...
import { BedrockConfig } from './bedrock-config.tsx';
// Import the singleton Supabase client
import supabase from "./supabase.tsx";
// Import diagnostic tool in development mode only
import { runClientDiagnostic } from './detect-client-duplicates.ts';
 ...
 */
const needsTokenRefresh = (session): void => {
 ...
 */
const handleSpecialErrors = (errorText): void => {
 ...
 */
const callEdgeFunction = async ({ action, data = {}, requireAuth }): Promise<void> => {
 ...
 */
const testAwsPermissions = async (): Promise<void> => {
