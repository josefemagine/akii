...
import { supabase, supabaseAdmin, auth, getSupabaseClient, getAdminClient, getAuth } from "./supabase-singleton";
// Import from auth-helpers
import { 
// User functions
getCurrentUser, getCurrentSession, getUserProfile, ensureUserProfile, updateUserProfile, setUserRole, setUserStatus } from "./auth-helpers";
