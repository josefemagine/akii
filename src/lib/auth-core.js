...
import { signIn, signUp, signOut, resetPasswordForEmail as resetPassword, updatePassword, getCurrentSession, getCurrentUser, getUserProfile, ensureUserProfile, updateUserProfile, setUserRole, setUserStatus, verifySupabaseConnection } from './auth-helpers';
