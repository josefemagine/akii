...
interface supabase-auth-recoveryProps {}
...
export function checkAuthStatus() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            return {
                hasSession: !!(session === null || session === void 0 ? void 0 : session.session),
                hasUser: !!(userData === null || userData === void 0 ? void 0 : userData.user),
                hasTokens,
                hasAuthData,
                isAuthenticated: !!(session === null || session === void 0 ? void 0 : session.session) || !!(userData === null || userData === void 0 ? void 0 : userData.user) || hasTokens
            };
        }
        catch (error) {
 ...
 */
function checkLocalStorageForTokens() {
    try {
        const authKeys = Object.keys(localStorage).filter(key => key.includes('supabase.auth.token') ||
            key.includes('sb-') ||
...
function checkLocalStorageForAuthData() {
    try {
        const authDataKeys = Object.keys(localStorage).filter(key => key.includes('user') ||
 ...
 */
export function tryRepairAuthIssues() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const authStatus = yield checkAuthStatus();
 ...
 */
export function authRecoveryMiddleware() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
