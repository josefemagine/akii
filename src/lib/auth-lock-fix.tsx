...
const timedOutOperations = new Set();
 ...
 */
const getRetryDelay = (attempt): void => {
 ...
 */
function executeWithRetry(operation, operationName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let attempt = 0; attempt <= CONFIG.MAX_RETRY_COUNT; attempt++) {
            try {
                ...
                const isLockError = errorMsg.includes('lock') ||
            ...
            const checkPromise = (() => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    const sessionPromise = supabase.auth.getSession()
                        ...
                        if ((_a = result === null || result === void 0 ? void 0 : result.data) === null || _a === void 0 ? void 0 : _a.session) {
                    ...
                    try {
                        const result = yield Promise.race([sessionPromise, timeoutPromise]);
                        return result;
                    }
                    catch (raceError) {
                        // If timeout won the race and we found a token earlier, use it as fallback
                        if (((_a = raceError.message) === null || _a === void 0 ? void 0 : _a.includes('timed out')) && tokenKey) {
                            try {
                                const tokenData = JSON.parse(localStorage.getItem(tokenKey) || '{}');
                                if (tokenData === null || tokenData === void 0 ? void 0 : tokenData.access_token) {
                                    // Extract user info from token if available
 ...
 */
export function withAuthLock(operation_1) {
    return __awaiter(this, arguments, void 0, function* (operation, operationName = 'auth-operation') {
        var _a;
        ...
        if (operationName === 'getSession' && sessionCache.session && (now - sessionCache.timestamp < CONFIG.SESSION_CACHE_TIME)) {
            ...
            return Promise.resolve({ data: { session: sessionCache.session }, error: null });
        }
        ...
        if (!isAuthOperationInProgress) {
            ...
            try {
                const result = yield executeWithRetry(operation, operationName);
                // Cache session results
                if (operationName === 'getSession') {
                    const typedResult = result;
                    if ((_a = typedResult === null || typedResult === void 0 ? void 0 : typedResult.data) === null || _a === void 0 ? void 0 : _a.session) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const queuedOperation = () => __awaiter(this, void 0, void 0, function* () {
                var _a;
 ...
 */
export function getSessionSafely() {
    return __awaiter(this, void 0, void 0, function* () {
        return yield withAuthLock(() => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield supabase.auth.getSession();
                return {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        return yield withAuthLock(() => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const sessionResult = yield supabase.auth.getSession();
                if (!sessionResult.data.session) {
                    return { data: { user: null }, error: null };
                }
                // Now get the user with confidence that session exists
                const result = yield supabase.auth.getUser();
                return {
...
function checkIfPublicPage() {
    ...
    return publicPaths.some(path => path === pathname ||
        (path.endsWith('/') && pathname.startsWith(path)));
}
/**
 * Sign out with lock protection
 */
export function signOutSafely(options) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            return yield withAuthLock(() => supabase.auth.signOut(options), 'signOut');
        }
        catch (error) {
 ...
 */
export function signInWithEmailSafely(email, password) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            return yield withAuthLock(() => supabase.auth.signInWithPassword({ email, password }), 'signInWithEmail');
        }
        catch (error) {
 ...
 */
export function signUpSafely(email, password, options) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            return yield withAuthLock(() => supabase.auth.signUp({
                email,
                password,
                options: options || {}
            }), 'signUp');
 ...
 */
export function forceSessionCheck() {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
export function forceUserCheck() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c, _d, _e;
        ...
        try {
            ...
            if (sessionResult.data.session) {
                ...
                if (userId) {
                    ...
                    const fallbackUser = {
                        id: userId,
                        email: ((_b = session.user) === null || _b === void 0 ? void 0 : _b.email) || '',
                        app_metadata: ((_c = session.user) === null || _c === void 0 ? void 0 : _c.app_metadata) || {},
                        user_metadata: ((_d = session.user) === null || _d === void 0 ? void 0 : _d.user_metadata) || {},
                        aud: 'authenticated',
                        created_at: ''
                    };
                    ...
                    try {
                        localStorage.setItem('akii-auth-user-id', userId);
                        if ((_e = session.user) === null || _e === void 0 ? void 0 : _e.email) {
