...
interface CACHE_TTLProps {}

// Profile cache to avoid repeated fetches
const profileCache = new Map();
const CACHE_TTL = 5 * 60 * 1000; // 5 minutes
const getProfileFromCache = (userId): void => {
...
const setProfileInCache = (userId, profile): void => {
    profileCache.set(userId, {
        profile,
        timestamp: Date.now(),
    });
};
export const getUserProfile = (userId_1, ...args_1) => __awaiter(void 0, [userId_1, ...args_1], void 0, function* (userId, forceRefresh = false) {
    if (!userId)
        return null;
    try {
        ...
        if (error) {
            ...
            if (forceRefresh && (userId === "b574f273-e0e1-4cb8-8c98-f5a7569234c8" || // Josef
