...
const WebChatAnimation = () => {
    ...
    const [activeDemo, setActiveDemo] = useState("support");
    const [demoChangeTimer, setDemoChangeTimer] = useState(null);
    ...
    return (_jsxs("div", { className: "w-full h-full bg-card rounded-lg shadow-xl overflow-hidden flex flex-col border border-primary/20", children: [_jsxs("div", { className: cn("p-4 flex items-center justify-between", activeDemo === "support"
                    ? "bg-gray-800 text-white"
                    : "bg-primary text-primary-foreground"), children: [_jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("div", { className: "h-3 w-3 rounded-full bg-green-400 animate-pulse" }), _jsx("h3", { className: "font-medium", children: getDemoTitle() })] }), _jsxs("div", { className: "flex space-x-2", children: [_jsx("div", { className: cn("h-2 w-2 rounded-full", activeDemo === "support" ? "bg-white/70" : "bg-primary-foreground/70") }), _jsx("div", { className: cn("h-2 w-2 rounded-full", activeDemo === "support" ? "bg-white/70" : "bg-primary-foreground/70") }), _jsx("div", { className: cn("h-2 w-2 rounded-full", activeDemo === "support" ? "bg-white/70" : "bg-primary-foreground/70") })] })] }), _jsxs("div", { className: "flex-1 p-4 overflow-y-auto flex flex-col space-y-4 bg-muted/20", children: [_jsx(AnimatePresence, { children: messages.map((message) => (_jsx(motion.div, { initial: { opacity: 0, y: 20, scale: 0.95 }, animate: { opacity: 1, y: 0, scale: 1 }, exit: { opacity: 0, scale: 0.95, transition: { duration: 0.2 } }, transition: { duration: 0.3 }, className: cn("max-w-[85%] p-3 rounded-lg", message.sender === "user"
                                ...
                                : message.isCode
                                    ...
                                    : message.isHighlighted
                                        ...
                                        : "bg-primary text-primary-foreground self-start rounded-bl-none"), children: message.isCode ? (_jsx("pre", { className: "whitespace-pre-wrap", children: message.text })) : (message.text) }, `${activeDemo}-${message.id}`))) }), typing && (_jsx(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, className: "bg-primary text-primary-foreground self-start rounded-lg rounded-bl-none max-w-[80%] p-3", children: _jsxs("div", { className: "flex space-x-2", children: [_jsx(motion.div, { className: "h-2 w-2 rounded-full bg-primary-foreground", animate: { scale: [1, 1.2, 1] }, transition: {
                                        repeat: Infinity,
                                        duration: 1,
                                        repeatType: "loop",
                                    } }), _jsx(motion.div, { className: "h-2 w-2 rounded-full bg-primary-foreground", animate: { scale: [1, 1.2, 1] }, transition: {
                                        repeat: Infinity,
                                        duration: 1,
                                        delay: 0.3,
                                        repeatType: "loop",
                                        ...
                                        delay: 0.6,
                                        repeatType: "loop",
                                    } })] }) })), _jsx("div", { ref: messagesEndRef })] }), _jsx("div", { className: "px-4 py-2 bg-muted/10 border-t border-border/50 flex justify-center", children: _jsxs("div", { className: "flex space-x-2", children: [_jsx(motion.div, { className: `h-2 w-2 rounded-full ${activeDemo === "support" ? "bg-primary" : "bg-muted"}`, animate: activeDemo === "support" ? { scale: [1, 1.2, 1] } : {}, transition: { repeat: Infinity, duration: 2 } }), _jsx(motion.div, { className: `h-2 w-2 rounded-full ${activeDemo === "sales" ? "bg-primary" : "bg-muted"}`, animate: activeDemo === "sales" ? { scale: [1, 1.2, 1] } : {}, transition: { repeat: Infinity, duration: 2 } })] }) }), _jsx("div", { className: "p-4 border-t bg-background", children: _jsxs("div", { className: "flex items-center", children: [_jsx("input", { type: "text", placeholder: "Type your message...", className: "flex-1 bg-muted/30 p-2 rounded-l-md focus:outline-none", disabled: true }), _jsx("button", { className: "bg-primary text-primary-foreground p-2 rounded-r-md hover:bg-primary/90 transition-colors", children: _jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("path", { d: "m22 2-7 20-4-9-9-4Z" }), _jsx("path", { d: "M22 2 11 13" })] }) })] }) })] }));
};
