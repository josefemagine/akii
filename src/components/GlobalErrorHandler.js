...
import { getSessionSafely, getUserSafely, clearAuthLocks, emergencySessionReset, getAuthLockStatus, forceSessionCheck, forceUserCheck } from '@/lib/auth-lock-fix';
/**
...
export function GlobalErrorHandler() {
    ...
    const authValidationTimer = useRef(null);
    const authCheckInProgress = useRef(false);
    const lastValidationTime = useRef(0);
    const nextValidationDue = useRef(0);
    // Efficiently track auth state to avoid redundant validation
    const authStateRef = useRef({
        hasUser: Boolean(auth.user),
        isLoading: Boolean(auth.isLoading),
        userId: ((_a = auth.user) === null || _a === void 0 ? void 0 : _a.id) || null
    });
    ...
    useEffect(() => {
        ...
        const hasRelevantChanges = newState.hasUser !== authStateRef.current.hasUser ||
    ...
    useEffect(() => {
        try {
            ...
            window.__AUTH_LOCK_STATUS = () => {
                const locks = window.__SUPABASE_AUTH_LOCK_STATUS;
                return {
                    isOperationInProgress: (locks === null || locks === void 0 ? void 0 : locks.isAuthOperationInProgress) || false,
                    lockHolder: (locks === null || locks === void 0 ? void 0 : locks.lockHolder) || null,
                    lastOperationTime: (locks === null || locks === void 0 ? void 0 : locks.lastOperationTime) || 0,
                    timeSinceLastOperation: (locks === null || locks === void 0 ? void 0 : locks.lastOperationTime) ? Date.now() - (locks === null || locks === void 0 ? void 0 : locks.lastOperationTime) : null
                };
            };
        ...
        const intervalId = setInterval(() => {
            var _a, _b;
            try {
                const lockStatus = (_b = (_a = window).__AUTH_LOCK_STATUS) === null || _b === void 0 ? void 0 : _b.call(_a);
                if ((lockStatus === null || lockStatus === void 0 ? void 0 : lockStatus.isOperationInProgress) && lockStatus.timeSinceLastOperation > 5000) {
    ...
    useEffect(() => {
        ...
        window.addEventListener('akii:auth:error', handleAuthError);
        return () => {
            window.removeEventListener('akii:auth:error', handleAuthError);
        };
    }, []);
    ...
    const updateAuthStatus = useCallback(() => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let sessionResult = yield getSessionSafely();
            let userResult = yield getUserSafely();
            ...
            if (sessionResult.error) {
                ...
                sessionResult = yield forceSessionCheck();
            }
            if (userResult.error) {
                // Only log warning if it's not an expected auth session missing error
                ...
                userResult = yield forceUserCheck();
            }
            // Check if there are actual errors or just no session/user
            const hasRealErrors = (sessionResult.error && typeof sessionResult.error === 'object' && sessionResult.error.message !== 'No session found') ||
            ...
            else if (((_a = sessionResult.data) === null || _a === void 0 ? void 0 : _a.session) || ((_b = userResult.data) === null || _b === void 0 ? void 0 : _b.user)) {
            ...
            return {
                session: (_c = sessionResult.data) === null || _c === void 0 ? void 0 : _c.session,
                user: (_d = userResult.data) === null || _d === void 0 ? void 0 : _d.user,
                hasSession: !!((_e = sessionResult.data) === null || _e === void 0 ? void 0 : _e.session),
                hasUser: !!((_f = userResult.data) === null || _f === void 0 ? void 0 : _f.user),
    ...
    const validateAuthState = useCallback((...args_1) => __awaiter(this, [...args_1], void 0, function* (force = false) {
        ...
        try {
            ...
            const statusCheck = yield updateAuthStatus();
            ...
            if (statusCheck.hasErrors ||
                ...
                if ((errorCount > 2 || force) && !recoveryInProgress) {
                    yield attemptAuthRecovery(force);
                }
                return false;
            }
            return true;
    ...
    const attemptAuthRecovery = useCallback((...args_1) => __awaiter(this, [...args_1], void 0, function* (force = false) {
        var _a, _b;
        if (recoveryInProgress && !force)
            return false;
        try {
            ...
            const sessionResult = yield forceSessionCheck();
            const userResult = yield forceUserCheck();
            console.log('Recovery check results:', {
                hasSession: !!sessionResult.data.session,
                hasUser: !!userResult.data.user,
                sessionError: (_a = sessionResult.error) === null || _a === void 0 ? void 0 : _a.message,
                userError: (_b = userResult.error) === null || _b === void 0 ? void 0 : _b.message
            });
            ...
            if ((sessionResult.error || userResult.error) ||
                ...
                const hasOnlyAuthSessionMissingErrors = (!sessionResult.error || isAuthSessionMissingError(sessionResult.error)) &&
    ...
    useEffect(() => {
        var _a, _b;
        if (((_a = auth.user) === null || _a === void 0 ? void 0 : _a.id) && !auth.isAdmin) {
            ...
            if (isOnDashboard) {
                ...
                if ((_b = auth.user) === null || _b === void 0 ? void 0 : _b.email) {
    ...
    }, [(_b = auth.user) === null || _b === void 0 ? void 0 : _b.id, auth.isAdmin]);
    // This component doesn't render anything visually
    return null;
}
export default GlobalErrorHandler;
function checkUserAdminStatusDirectly(userId) {
