...
export default function SupabaseBedrock() {
  ...
  const [modelId, setModelId] = useState(BedrockConfig.defaultModel);
  const [commitmentDuration, setCommitmentDuration] = useState(BedrockConfig.defaultCommitmentDuration);
  const [modelUnits, setModelUnits] = useState(BedrockConfig.defaultModelUnits);
  ...
  const getCommitmentName = (commitmentId) => {
