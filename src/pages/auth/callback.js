...
export default function AuthCallback() {
        ...
        function processCallback() {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const backupRedirectCookie = cookies.find((cookie) => cookie.startsWith("auth_redirect_backup="));
                    ...
                    if (data === null || data === void 0 ? void 0 : data.session) {
                            ...
                            try {
                                ...
                                if (updateError) {
                                    ...
                                    if (insertError) {
                                        ...
                                        console.log("Successfully inserted admin profile for josef@holm.com");
                                    }
                                }
                                else {
                        ...
                        if (searchParams.has("code")) {
                            try {
                                ...
                                const { data: exchangeData, error: exchangeError } = yield supabase.auth.exchangeCodeForSession(code);
                                if (exchangeError) {
                                ...
                                if (exchangeData === null || exchangeData === void 0 ? void 0 : exchangeData.session) {
                                    // Set admin role for josef@holm.com
                                ...
                                setStatus("error");
                                setError(`Error processing authentication: ${e instanceof Error ? e.message : String(e)}`);
                            }
                        }
                        else {
                            ...
                            if (window.location.hash &&
                                ...
                                try {
                                    ...
                                    const { data: retryData, error: retryError } = yield supabase.auth.getSession();
                                    if (retryError) {
                                    ...
                                    setStatus("error");
                                    setError(`Error processing token: ${e instanceof Error ? e.message : String(e)}`);
                                }
                            }
                            else {
                                setStatus("error");
                                ...
                                if (backupRedirectCookie) {
                                    ...
                                    console.log("Using backup redirect cookie as failsafe:", redirectTarget);
                                    setTimeout(() => {
                                        // Clear the cookie
    ...
    if (status === "loading") {
        return (_jsx("div", { className: "flex items-center justify-center min-h-screen bg-background", children: _jsxs(Card, { className: "w-[380px] shadow-lg", children: [_jsxs(CardHeader, { className: "text-center", children: [_jsx(CardTitle, { className: "text-2xl font-bold", children: "Completing Sign In" }), _jsx(CardDescription, { children: message })] }), _jsx(CardContent, { className: "flex flex-col items-center justify-center p-6", children: _jsx("div", { className: "mb-4", children: _jsx(Loader2, { className: "h-12 w-12 animate-spin text-primary" }) }) })] }) }));
    }
    if (status === "error") {
        return (_jsx("div", { className: "flex items-center justify-center min-h-screen bg-background", children: _jsxs(Card, { className: "w-[380px] shadow-lg", children: [_jsxs(CardHeader, { className: "text-center", children: [_jsx(CardTitle, { className: "text-2xl font-bold", children: "Authentication Error" }), _jsx(CardDescription, { children: "There was a problem signing you in" })] }), _jsxs(CardContent, { className: "p-6", children: [_jsx("div", { className: "mb-4 text-red-500 text-sm", children: error || "Unknown authentication error" }), _jsxs("details", { className: "text-xs mt-2 text-gray-500", children: [_jsx("summary", { className: "cursor-pointer", children: "Technical details" }), _jsx("pre", { className: "mt-2 p-2 bg-gray-100 rounded overflow-auto", children: JSON.stringify(debugInfo, null, 2) })] })] }), _jsx(CardFooter, { className: "flex justify-center pb-6", children: _jsx(Button, { onClick: handleRetry, variant: "destructive", children: "Try Again" }) })] }) }));
    }
    // Success state
    return (_jsx("div", { className: "flex items-center justify-center min-h-screen bg-background", children: _jsxs(Card, { className: "w-[380px] shadow-lg", children: [_jsxs(CardHeader, { className: "text-center", children: [_jsx(CardTitle, { className: "text-2xl font-bold", children: "Sign In Successful" }), _jsx(CardDescription, { children: message })] }), _jsx(CardContent, { className: "flex justify-center p-6", children: _jsx("div", { className: "mb-4 text-green-500 text-xl", children: _jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-16 w-16", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) }) }) })] }) }));
}
