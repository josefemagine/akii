...
export default function AdminForcedAccess() {
  ...
  // Create placeholder functions for missing methods
  const forceAdminRole = () => console.log("Force admin role called");
  const refreshUserRole = async () => console.log("Refresh user role called");
      ...
      <Card className="max-w-md mx-auto">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <p>
              All admin overrides have been applied. Click the button below to
              access the admin area:
            </p>

            <Button onClick={accessAdmin} className="w-full">
          ...
          <div className="text-sm text-muted-foreground">
            <p>
              This page bypasses normal admin checks and forces admin access
