...
// Find all TypeScript/React files in the src directory - use relative path
const SRC_FILES = '../**/*.{ts,tsx}';
...
async function processFiles() {
  ...
  console.log(`Looking for files with pattern: ${SRC_FILES}`);
  
  // Use simple pattern with working directory
